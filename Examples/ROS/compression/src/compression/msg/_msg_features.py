...
"""autogenerated by genpy from compression/msg_features.msg. Do not edit."""
import sys
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(msg_features, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.tframe is None:
        self.tframe = 0.
      if self.nrobotid is None:
        self.nrobotid = 0
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_dh().pack(_x.tframe, _x.nrobotid))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.tframe, _x.nrobotid,) = _get_struct_dh().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sb'%length
